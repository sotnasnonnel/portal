...
export const TERMOS_FIN = {
  cartao_virtual: {
    titulo: 'Termos de Uso e Responsabilidade — Cartão Virtual',
    ...
    itens: [
      ...
      ['Prestação de contas diária', 'a nota fiscal/comprovante de cada gasto deve ser anexada no sistema no mesmo dia em que a despesa ocorrer. O descumprimento pode levar ao cancelamento automático do cartão pelo sistema, com bloqueio do crédito remanescente.'],
      ...
      ['Auditoria', 'a PHD pode auditar, a qualquer momento, o uso do cartão e a documentação anexada.'],
    ],
  },
  aumento_limite: {
    titulo: 'Termos de Uso e Responsabilidade — Aumento de Limite de Cartão Virtual',
    intro: 'Ao prosseguir com a solicitação, você declara estar ciente e de acordo com:',
    itens: [
      ...
      ['Prestação de contas diária', 'permanece válida a regra de comprovação no mesmo dia da despesa, incluindo os gastos cobertos pelo limite adicional. O descumprimento pode levar ao cancelamento automático do cartão pelo sistema.'],
